var Task = function(data) {
  this.flyWeights = flyWeightFactory.get(
    data.project,
    data.priority,
    data.user,
    data.completed
...
Task.prototype.getPriority = function() {
  return this.flyWeights.priority;
};
...
var flyWeightFactory = (function(project, priority, user, completed) {
  var flyWeights = {};
